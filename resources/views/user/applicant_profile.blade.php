    ...
    <div class="container">  
        ...
        <div class="job-header">
                ...
                <div class="row">
                   <div class="col-md-8 col-sm-8">
                        ...
                        <div class="candidateinfo">
                            <div class="userPic">{{$user->printUserImage()}}111</div>
                            <div class="title">
            ...
            <div class="jobButtons">
                ...
                @endif
                    ...
                    <a href="{{ URL::to('/customers/pdf', [$user->id]) }}" class="btn"><i class="fa fa-download" aria-hidden="true"></i> {{__('Download CV')}}</a>
        ...
        <div class="row">
            ...
            <div class="col-md-4"> 
                ...
                <div class="job-header">
                    <div class="jobdetail">
                        <h3 id="contact_applicant">{{$user->getName()}}</h3>
