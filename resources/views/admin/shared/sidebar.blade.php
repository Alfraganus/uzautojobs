...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
        ...
        <li class="nav-item start active"> <a href="{{ route('admin.home') }}" class="nav-link"> <i class="icon-home"></i> <span class="title">Дашборд</span> </a> </li>
        @include('admin/shared/side_bars/admin_user')

        <li class="heading">
            <h3 class="uppercase">Модулы</h3>
        </li>
        ...
        <li class="heading">
            <h3 class="uppercase"> УПРАВЛЕНИЕ РАСПОЛОЖЕНИЕМ</h3>
        </li>
        ...
        <li class="heading">
            <h3 class="uppercase">ПОЛЬЗОВАТЕЛЬСКИЕ ПАКЕТЫ</h3>
        </li>
        ...
        <li class="heading">
            <h3 class="uppercase">Атрибуты работы</h3>
        </li>
...
{{--        @include('admin/shared/side_bars/career_level')--}}
      ...
      {{--  @include('admin/shared/side_bars/job_type') --}}
        ...
        <li class="heading">
            <h3 class="uppercase">управлять</h3>
        </li>		 
