...
<div class="form-body">
    ...
    <br> 
    <fieldset>
        <legend>SendMail - притворяться настройки:</legend>     
    ...
    <br>
    <fieldset>
        <legend>Настройки MailGun:</legend>    
    ...
    <br>
    <fieldset>
        <legend>Настройки Mandrill:</legend>    
    ...
    <br>
    <fieldset>
        <legend>Настройки Sparkpost:</legend>    
    ...
    <br>
    <fieldset>
        <legend>Настройки AMAZON SES:</legend>        
