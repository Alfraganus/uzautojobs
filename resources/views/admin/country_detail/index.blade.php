...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
        ...
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Управление страной</h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Страны</span> </div>            
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="countryDetailDatatableAjax">
                                    <thead>
                                        <tr role="row" class="heading">
                                            <th>Страна</th>
                                            <th>Сортировать имя</th>
                                            <th>Код телефона</th>
                                            <th>Валюта</th>
                                            <th>Код</th>
                                            <th>Символ</th>
                                            <th>Тысяча<br />Разделитель</th>
                                            <th>Десятичный<br />Разделитель</th>                      
                                            <th>Действия</th>
                                        </tr>
                                    </thead>
                                    <tbody>
