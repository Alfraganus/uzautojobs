...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'lang') !!}">
        ...
        {!! Form::text('lang', null, array('class'=>'form-control', 'id'=>'lang', 'placeholder'=>'Язык')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'lang') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'native') !!}">
        {!! Form::label('native', 'Родные', ['class' => 'bold']) !!}
        {!! Form::text('native', null, array('class'=>'form-control', 'id'=>'native', 'placeholder'=>'Родные')) !!}
