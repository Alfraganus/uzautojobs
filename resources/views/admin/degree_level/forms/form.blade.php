...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level') !!}">
        {!! Form::label('degree_level', 'Степень Уровень', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
        {!! Form::label('degree_level_id', 'Уровень по умолчанию', ['class' => 'bold']) !!}                    
        {!! Form::select('degree_level_id', ['' => 'Выберите уровень по умолчанию']+$degreeLevels, null, array('class'=>'form-control', 'id'=>'degree_level_id')) !!}
