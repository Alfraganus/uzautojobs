...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'testimonial_by') !!}">
        {!! Form::label('testimonial_by', 'Отзыв от', ['class' => 'bold']) !!}
        {!! Form::text('testimonial_by', null, array('class'=>'form-control', 'id'=>'testimonial_by', 'placeholder'=>'Отзыв от', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'testimonial_by') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'testimonial') !!}">
        {!! Form::label('testimonial', 'Отзыв', ['class' => 'bold']) !!}
        {!! Form::textarea('testimonial', null, array('class'=>'form-control', 'id'=>'testimonial', 'placeholder'=>'Отзыв', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'testimonial') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'company') !!}">
        {!! Form::label('company', 'Компания и Обозначение', ['class' => 'bold']) !!}
        {!! Form::text('company', null, array('class'=>'form-control', 'id'=>'company', 'placeholder'=>'Компания и Обозначение', 'dir'=>$direction)) !!}
