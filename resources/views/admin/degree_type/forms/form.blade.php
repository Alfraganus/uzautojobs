...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'lang') !!}" id="lang_div">
        {!! Form::label('lang', 'Язык', ['class' => 'bold']) !!}                    
        {!! Form::select('lang', ['' => 'Выберите язык']+$languages, $lang, array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'setLang(this.value)')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'lang') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
        {!! Form::label('degree_level_id', 'Степень Уровень', ['class' => 'bold']) !!}                    
        {!! Form::select('degree_level_id', ['' => 'Выберите уровень степени']+$degreeLevels, null, array('class'=>'form-control', 'id'=>'degree_level_id')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'degree_level_id') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_type') !!}">
        {!! Form::label('degree_type', 'Степень Типа', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_type_id') !!}" id="degree_type_id_div">
        {!! Form::label('degree_type_id', 'Тип степени по умолчанию', ['class' => 'bold']) !!}                    
        {!! Form::select('degree_type_id', ['' => 'Выберите тип степени по умолчанию']+$degreeTypes, null, array('class'=>'form-control', 'id'=>'degree_type_id')) !!}
    ...
    <div class="form-actions">
        {!! Form::button('Обновить <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>', array('class'=>'btn btn-large btn-primary', 'type'=>'submit')) !!}
    </div>
</div>
@push('scripts')
