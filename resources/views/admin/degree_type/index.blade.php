    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Степень Тип</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Управление типами степеней <small>Степень Тип</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Степени Типы</span> </div>
                        <div class="actions"> <a href="{{ route('create.degree.type') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i>Добавить новый тип степени</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="degreeTypeDatatableAjax">
                                    <thead>                                        
                                        ...
                                        <tr role="row" class="heading">
                                            <th>Язык</th><th>Степень Уровень</th><th>Степень Тип</th><th>Действия</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
