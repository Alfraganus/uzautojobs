                ...
                <tr>
                    <td class="row" valign="top" style="padding-left:12px;padding-right:12px;padding-top:18px;padding-bottom:12px">
                        <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            <tr>
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px;    
                                text-align: left;">{{ $siteSetting->site_name }} "ADMINISTRATOR" has created your account in {{ $siteSetting->site_name }} "ADMIN PANEL". Пожалуйста, установите свой пароль, используя эту ссылку:<br />
                                    <br>
                            ...
                            <tr>
                                <td style="font-family: Helvetica, Arial, sans-serif;font-size: 14px;line-height: 22px;font-weight: 400;color: #333;
                                    padding-bottom: 30px;text-align: left;">Thanks, <br>The {{ $siteSetting->site_name }} команда</td>
                            </tr>
                        </table>
                        <br>
                    </td>
