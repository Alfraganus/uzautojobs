...
<div class="form-body">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'lang') !!}"> {!! Form::label('lang', 'Язык', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'career_level') !!}"> {!! Form::label('career_level', 'Карьерный уровень', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_default') !!}"> {!! Form::label('is_default', 'По умолчанию?', ['class' => 'bold']) !!}
