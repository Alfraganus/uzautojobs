...
<div class="form-body">
    <h3>Перетащите, чтобы отсортировать вопросы</h3>
    {!! Form::select('lang', ['' => 'Выберите язык']+$languages, config('default_lang'), array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'refresh_faq_sort_data();')) !!}	
