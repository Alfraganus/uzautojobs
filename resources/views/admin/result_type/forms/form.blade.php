...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'result_type') !!}">
        {!! Form::label('result_type', 'Тип результата', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'result_type_id') !!}" id="result_type_id_div">
        {!! Form::label('result_type_id', 'Тип результата по умолчанию', ['class' => 'bold']) !!}                    
        {!! Form::select('result_type_id', ['' => 'Выберите тип результата по умолчанию']+$resultTypes, null, array('class'=>'form-control', 'id'=>'result_type_id')) !!}
