...
<div class="form-body">
    <h3>Перетащите для сортировки типов результатов</h3>
    {!! Form::select('lang', ['' => 'Выберите язык']+$languages, 'en', array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'refreshResultTypeSortData();')) !!}
