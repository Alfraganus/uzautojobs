...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'lang') !!}" id="lang_div">
        ...
        {!! Form::select('lang', ['' => 'Выберите язык']+$languages, $lang, array('class'=>'form-control', 'id'=>'lang')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'lang') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'marital_status') !!}">
        {!! Form::label('marital_status', 'Семейное положение', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'marital_status_id') !!}" id="marital_status_id_div">
        {!! Form::label('marital_status_id', 'Семейное положение по умолчанию', ['class' => 'bold']) !!}                    
        {!! Form::select('marital_status_id', ['' => 'Выберите семейное положение по умолчанию']+$maritalStatuses, null, array('class'=>'form-control', 'id'=>'marital_status_id')) !!}
