...
<div class="form-body">
    ...
    <div class="form-group">
        ...
        {!! Form::text('yonalish', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Йўналиш','required')) !!}
    </div>

    <div class="form-group">
        {!! Form::label('turar_joy', 'Турар жой манзили', ['class' => 'bold']) !!}
        {!! Form::text('turar_joy', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Турар жой манзили','required')) !!}
    </div>

    <div class="form-group">
        {!! Form::label('yashash_joy', 'Яшаш жой манзили', ['class' => 'bold']) !!}
        {!! Form::text('yashash_joy', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Яшаш жой манзили','required')) !!}
    </div>


    <div class="form-group">
        {!! Form::label('trip_readiness', 'Хизмат сафарига муносабатингиз', ['class' => 'bold']) !!}
        {!! Form::select('trip_readiness', ['Ижобий ','Салбий'], null, ['class' => 'form-control','required']) !!}
{{--        {!! Form::text('trip_readiness', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Хизмат сафарига муносабатингиз')) !!}--}}
    </div>

    <div class="form-group">
        {!! Form::label('driving_licence', 'Хайдовчилик гувоҳномаси (бор бўлса тоифаси, гувоҳномаси бўлмаса, йўқ деб тўлдиринг):', ['class' => 'bold']) !!}
        {!! Form::text('driving_licence', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Хайдовчилик гувоҳномаси:','required')) !!}
    </div>

    <div class="form-group">
        {!! Form::label('children_quantity', 'Фарзанди (сони)', ['class' => 'bold']) !!}
        {!! Form::text('children_quantity', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Фарзанди (сони)','required')) !!}
    </div>

    <div class="form-group">
        {!! Form::label('work_shift_readiness', 'Сменалик ишга бўлган муносабатингиз:', ['class' => 'bold']) !!}
        {!! Form::select('work_shift_readiness', ['Розиман ','Рози эмасман'], null, ['class' => 'form-control']) !!}
    </div>
    ...
    <div class="form-group">
        ...
        {!! Form::text('army_document', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Харбий хизмат тўғрисида маълумот','required')) !!}
    </div>

    <div class="form-group">
        {!! Form::label('sudlangan', 'Судланганлиги:', ['class' => 'bold']) !!}
        {!! Form::select('sudlangan', ['Судланмаганман ','Судланганман'], null, ['class' => 'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label('height', 'Бўйи: (см)', ['class' => 'bold']) !!}
        {!! Form::text('height', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Бўйи: (см)','required')) !!}
    </div>
    <div class="form-group">
        {!! Form::label('extra_info', 'Қўшимча маълумот', ['class' => 'bold']) !!}
        {!! Form::textarea('extra_info', null, array('class'=>'form-control', 'id'=>'middle_name', 'placeholder'=>'Қўшимча маълумот')) !!}
    </div>
