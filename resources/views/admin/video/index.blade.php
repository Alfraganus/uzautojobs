    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>Наше видео</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">Управление языками видео</h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i> <span class="caption-subject font-dark sbold uppercase">Языки видео</span> </div>
                        <div class="actions"> <a href="{{ route('create.video') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Добавить новый язык видео</a> </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="videoDatatableAjax">
                                    <thead>                                        
                                        <tr role="row" class="filter">
                                            <td>{!! Form::select('lang', ['' => 'Выберите язык']+$languages, null, array('id'=>'lang', 'class'=>'form-control')) !!}</td>
                                            <td><input type="text" class="form-control" name="video_title" id="video_title" autocomplete="off" placeholder="Video Title">
                                            </td><td><select name="is_active" id="is_active"  class="form-control"><option value="-1">Активен?</option><option value="1" selected="selected">Active</option><option value="0">Неактивный</option></select></td>
                                        </tr>
                                        <tr role="row" class="heading">
                                            <th>Language</th><th>Название видео</th><th>Действия</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
