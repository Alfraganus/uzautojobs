...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_image') !!}">
        {!! Form::label('slider_image', 'Слайдер изображение', ['class' => 'bold']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_heading') !!}">
        {!! Form::label('slider_heading', 'Заголовок слайдера', ['class' => 'bold']) !!}
        {!! Form::text('slider_heading', null, array('class'=>'form-control', 'id'=>'slider_heading', 'placeholder'=>'Заголовок слайдера', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'slider_heading') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_description') !!}">
        {!! Form::label('slider_description', 'Описание слайдера', ['class' => 'bold']) !!}
        {!! Form::textarea('slider_description', null, array('class'=>'form-control', 'id'=>'slider_description', 'placeholder'=>'Описание слайдера', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'slider_description') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_link') !!}">
        {!! Form::label('slider_link', 'Слайдер ссылка', ['class' => 'bold']) !!}
        {!! Form::text('slider_link', null, array('class'=>'form-control', 'id'=>'slider_link', 'placeholder'=>'Слайдер ссылка', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'slider_link') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_link_text') !!}">
        {!! Form::label('slider_link_text', 'Текст ссылки слайдера', ['class' => 'bold']) !!}
        {!! Form::text('slider_link_text', null, array('class'=>'form-control', 'id'=>'slider_link_text', 'placeholder'=>'Текст ссылки слайдера', 'dir'=>$direction)) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_id') !!}" id="slider_id_div">
        {!! Form::label('slider_id', 'Слайдер по умолчанию', ['class' => 'bold']) !!}                    
        {!! Form::select('slider_id', ['' => 'Выберите слайдер по умолчанию']+$sliders, null, array('class'=>'form-control', 'id'=>'slider_id')) !!}
