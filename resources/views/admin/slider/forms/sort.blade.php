...
<div class="form-body">
    <h3>Перетащите, чтобы сортировать слайдеры</h3>
    {!! Form::select('lang', ['' => 'Выберите язык']+$languages, config('default_lang'), array('class'=>'form-control', 'id'=>'lang', 'onchange'=>'refreshSliderSortData();')) !!}
