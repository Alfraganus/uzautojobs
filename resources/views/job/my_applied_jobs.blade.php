                ...
                <div class="myads">
                    ...
                    <ul class="searchList">
                        ...
                        <li>
                            ...
                            <?php $status = \App\JobApply::where(['user_id'=>Auth::user()->id])->where(['job_id'=>$job->id])->get();?>
                            @foreach($status as $status)
                            <h5 class="pull-right">статус вашей заявке на работу: <span style="color: #922B21 ;">{{$status->application_status}}</span></h5>
                        @endforeach
                        </li>
                        <!-- job end --> 
                        @endif
