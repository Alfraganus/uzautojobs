            ...
            <div class="col-md-9 col-sm-8">
                <div class="myads">
                    ...
                    <ul class="searchList">
                        ...
                        $profileCv = $job_application->user();
                        @endphp
                        ...
                        <li>
                            <div class="row">
                                <div class="col-md-5 col-sm-5">
                                    ...
                                    <div class="jobinfo">
                                        <h3><a href="{{route('applicant.profile', $job_application->id)}}">ID: {{$user->id}} / {{$user->getName()}}</a></h3>
                                        <div class="location"> {{$user->getLocation()}}</div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div style="font-size: 14px" class="minsalary">{{$job_application->expected_salary}} {{$job_application->salary_currency}} <span>/ {{$job->getSalaryPeriod('salary_period')}}</span></div>
                                </div>
