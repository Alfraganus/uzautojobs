...
Route::get('resume_list', 'IndexController@resume')->name('resume_list');


Route::get('view-public-profile/{id}', 'IndexController@viewPublicProfile')->name('view.public.profile');
Route::get('download-user-cv/{id}', 'IndexController@downloadUserCv')->name('download.user-cv');
...
//Route::get('/customers/pdf/{name}','ExportController@exporttest');
Route::get('/customers/pdf/{name}','ExportController@export_pdf');
Route::get('/testpdf','ExportController@generate_pdf');
/* * ******** OrderController ************ */
