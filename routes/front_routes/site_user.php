...
Route::post('show-front-profile-relative/{id}', 'UserController@showProfileRelative')->name('show.front.profile.relative');
Route::post('get-front-profile-relative-form/{id}', 'UserController@getFrontProfileRelativeForm')->name('get.front.profile.relative.form');
Route::post('store-front-profile-relative/{id}', 'UserController@storeProfileRelative')->name('store.front.profile.relative');
Route::delete('delete-front-profile-relative', 'UserController@deleteProfileRelative')->name('delete.front.profile.relative');
Route::post('get-front-profile-relative-edit-form/{id}', 'UserController@getFrontRelativeEditForm')->name('get.front.profile.relative.edit.form');
Route::put('update-front-profile-relative/{id}', 'UserController@updateFrontProfileRelative')->name('update.front.profile.relative');
