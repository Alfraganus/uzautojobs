...
class UserController extends Controller
{
    ...
    public function createUser()
    {
        ...
        $single_question_profile = new ResumeSingleQuestions();
        return view('admin.user.add',['$single_question_profile'=>$single_question_profile])
    ...
    public function storeUser(UserFormRequest $request)
    {
        ...
        $extra_info = new ResumeSingleQuestions();
        $extra_info->user_id =$user->id;
...
//        echo "<pre>";
//        echo var_dump(print_r($extra_info));
    ...
    public function editUser($id)
    {
        ...
        $industries = DataArrayHelper::defaultIndustriesArray();
        $functionalAreas = DataArrayHelper::defaultFunctionalAreasArray();
        $getuser = ResumeSingleQuestions::where(['user_id'=>$id])->first();
        ...
        $application_status = ApplicationStatus::pluck('status_name', 'status_code');
//        $application_status_chosen = ApplicationStatus::where(['status_code'=>$getuser->application_status])->pluck('status_name', 'status_code');
//        var_dump(print_r($application_status));die();
    ...
    public function updateUser($id, UserFormRequest $request)
    {
        ...
        if (ResumeSingleQuestions::where('user_id', '=', $id)->exists()) {
            $extra_info =  ResumeSingleQuestions::where(['user_id'=>$id])->first();
